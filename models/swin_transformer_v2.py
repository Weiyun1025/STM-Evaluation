...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
                 ...
                 layerscale_opt=False, layerscale_init_values=0., final_norm=False):
        super().__init__()
        self.dim = dim
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 layerscale_opt=False, layerscale_init_values=0., final_norm_index=[],
...
class SwinTransformerV2(nn.Module):
    ...
    def lr_decay_keywards(self, decay_ratio=0.87):
        ...
        lr_ratios["layers.0.downsample"] = lr_ratios['layers.1.blocks.0.']
        # layers.1.downsample (between stage-2 and stage-3)
        lr_ratios["layers.1.downsample"] = lr_ratios['layers.2.blocks.0.']
