...
from .blocks.convnext import ConvNeXtBlock, ConvNeXtV2Block, ConvNeXtV3Block, ConvNeXtV3SingleResBlock, ConvNeXtV4Block
...
@ register_model
def conv_convnext_v4_small(pretrained=False, **kwargs):
    model = MetaArch(img_size=224,
                     depths=[3, 3, 24, 3],
                     dims=[96, 192, 384, 768],
                     block_type=ConvNeXtV4Block,
                     **kwargs)
