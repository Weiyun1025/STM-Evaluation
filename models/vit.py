...
class Block(nn.Module):
    ...
    def __init__(
            ...
            drop_path=0., act_layer=nn.GELU, norm_layer=nn.LayerNorm, layerscale_opt=False, layerscale_init_values=1e-6):
        super().__init__()
    ...
    def forward(self, x):
        x = x + self.drop_path1(self.gamma_1 * self.ls1(self.attn(self.norm1(x))))
        x = x + self.drop_path2(self.gamma_2 * self.ls2(self.mlp(self.norm2(x))))
        return x
