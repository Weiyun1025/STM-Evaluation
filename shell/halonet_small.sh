...
srun -p ${PARTITION} \
    ...
    --weights "/mnt/petrelfs/share_data/shimin/share_checkpoint/halonet/halonet_v2_small/checkpoint-best.pth" \
    --num_data 2000
    #--output_dir "/mnt/petrelfs/${USER}/model_evaluation/${PROJECT_NAME}"
    
# sh ./shell/halonet_small.sh