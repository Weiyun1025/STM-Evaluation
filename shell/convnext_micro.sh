...
srun -p ${PARTITION} \
    ...
    --weights "/mnt/petrelfs/share_data/shimin/share_checkpoint/convnext/convnext_micro/checkpoint-best.pth" \
    --num_data 2000
    #--output_dir "/mnt/petrelfs/${USER}/model_evaluation/${PROJECT_NAME}"
    
# sh ./shell/convnext_micro.sh